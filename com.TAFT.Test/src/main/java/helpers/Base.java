...
public class Base {
	...
	public Base() {
		try {
			...
			FileInputStream fileInputStream = new FileInputStream("src\\main\\resources\\configurations\\Configuration.properties");
	...
	public static void elementClear(WebElement webElement) throws Exception {
		try {
			waitUntilElementVisible(webElement);
	...
	public static void elementClick(WebElement webElement) throws Exception {
		try {
			waitUntilElementVisible(webElement);
	...
	public static void elementDoubleClick(WebElement webElement) throws Exception {
		try {
			waitUntilElementVisible(webElement);
	...
	public static void elementDragAndDrop(WebElement sourceWebElement, WebElement targetWebElement) throws Exception {
		try {
			waitUntilElementVisible(sourceWebElement);
			waitUntilElementVisible(targetWebElement);
			
			if ((isElementDisplayed(sourceWebElement) && isElementEnabled(sourceWebElement)) && (isElementDisplayed(targetWebElement) && isElementEnabled(targetWebElement))) {
				Actions actions = new Actions(webDriver);
	...
	public static void elementDropdownSelect(WebElement webElement, String strOption, String strValue) throws Exception {
		try {
			waitUntilElementVisible(webElement);
	...
	public static void elementMouseHover(WebElement webElement) throws Exception {
		try {
			waitUntilElementVisible(webElement);
	...
	public static void elementRightClick(WebElement webElement) throws Exception {
		try {
			waitUntilElementVisible(webElement);
	...
	public static void elementSendKeys(WebElement webElement, String strKeys) throws Exception {
		try {
			waitUntilElementVisible(webElement);
	...
	// ================================================= See Functions =================================================
	public static void compareTextContains(String strActualValue, String strExpectedValue) throws Exception {
		try {
			Assert.assertTrue(strActualValue.contains(strExpectedValue));
		}
		catch (Exception exception) {
			exception.printStackTrace();
			throw new Exception("\"" + strActualValue + "\" not containing \"" + strExpectedValue + "\".");
		}
	}
	
	public static void compareTextEquals(String strActualValue, String strExpectedValue) throws Exception {
		try {
			Assert.assertEquals(strActualValue, strExpectedValue);
		}
		catch (Exception exception) {
			exception.printStackTrace();
			throw new Exception("\"" + strActualValue + "\" not equals to \"" + strExpectedValue + "\".");
		}
	}
	...
	public static boolean isElementEnabled(WebElement webElement) throws Exception {
		try {
	...
	public static boolean isElementSelected(WebElement webElement) throws Exception {
		try {
	...
	public static String getElementAttributeValue(WebElement webElement, String strAttribute) throws Exception {
		try {
			String strAttributeValue = webElement.getAttribute(strAttribute);
	...
	public static String getElementCssValue(WebElement webElement, String strCSS) throws Exception {
		try {
			String strCSSValue = webElement.getCssValue(strCSS);
	...
	public static String getElementDropdownSelectedValue(WebElement webElement) throws Exception {
		try {
			Select select = new Select(webElement);
	...
	public static String getElementText(WebElement webElement) throws Exception {
		try {
	...
	public static void waitUntilElementInvisible(WebElement webElement) throws Exception {
		try {
			WebDriverWait webDriverWait = new WebDriverWait(webDriver, 60);
	...
	public static void waitUntilElementVisible(WebElement webElement) throws Exception {
		try {
			WebDriverWait webDriverWait = new WebDriverWait(webDriver, 60);
